...
> Dùng cho release `50.5.3-prod-r1-snapshot-detail-alignment`.
...
```text
D:\Downloads\virtinfra-monitor-50.5.3-prod-r1-snapshot-detail-alignment\
```
...
```text
repo-root/
└── virtinfra-monitor-50.5.3-prod-r1-snapshot-detail-alignment/
    ├── app/
    ├── deploy/
    └── install.sh
```
