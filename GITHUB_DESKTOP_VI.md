...
> Dùng cho release `50.5.7-prod-r2-mac-identity-search`.
...
```text
D:\Downloads\virtinfra-monitor-50.5.7-prod-r2-mac-identity-search\
```
...
```text
repo-root/
└── virtinfra-monitor-50.5.7-prod-r2-mac-identity-search/
    ├── app/
    ├── deploy/
    └── install.sh
```
