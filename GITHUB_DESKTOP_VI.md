...
> Dùng cho release `50.5.8-prod-r2-friendly-agent-logs`.
...
```text
D:\Downloads\virtinfra-monitor-50.5.8-prod-r2-friendly-agent-logs\
```
...
```text
repo-root/
└── virtinfra-monitor-50.5.8-prod-r2-friendly-agent-logs/
    ├── app/
    ├── deploy/
    └── install.sh
```
