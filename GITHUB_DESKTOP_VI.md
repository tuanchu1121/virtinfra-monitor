...
> Dùng cho release `50.6.0-prod-r2-node-groups-update-detection-fix`.
...
```text
D:\Downloads\virtinfra-monitor-50.6.0-prod-r2-node-groups-update-detection-fix\
```
...
```text
repo-root/
└── virtinfra-monitor-50.6.0-prod-r2-node-groups-update-detection-fix/
    ├── app/
    ├── deploy/
    └── install.sh
```
