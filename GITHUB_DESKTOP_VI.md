...
> Dùng cho release `50.5.2-prod-r1-native-copy-ingest`.
...
```text
D:\Downloads\virtinfra-monitor-50.5.2-prod-r1-native-copy-ingest\
```
...
```text
repo-root/
└── virtinfra-monitor-50.5.2-prod-r1-native-copy-ingest/
    ├── app/
    ├── deploy/
    └── install.sh
```
