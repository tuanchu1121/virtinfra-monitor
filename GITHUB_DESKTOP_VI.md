...
> Dùng cho release `50.5.9-prod-r2-ui-layout-polish-only`.
...
```text
D:\Downloads\virtinfra-monitor-50.5.9-prod-r2-ui-layout-polish-only\
```
...
```text
repo-root/
└── virtinfra-monitor-50.5.9-prod-r2-ui-layout-polish-only/
    ├── app/
    ├── deploy/
    └── install.sh
```
