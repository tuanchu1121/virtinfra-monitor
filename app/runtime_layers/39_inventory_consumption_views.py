...
def bandwidth_consumption_page_v5058c():
    ...
    <div class="card v5058c-shell">
      ...
      %s
      %s
      <div class="v5058c-note">Data follows the monitor's existing timezone and refresh cycle. VM RX/TX is normalized to the guest perspective. VM rows use rolling five-minute slots packed inside hourly rollups, with hourly/daily totals for complete periods; no raw VM/NIC history is scanned. Search and pagination do not change the four overview totals.</div>
    </div>
    """ % (
