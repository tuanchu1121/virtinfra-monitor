...
Release `50.4.2-prod-r1-consumption-auth-fix` adds three Timescale hypertables without changing the existing current-state, Abuse, Storage I/O or Consumption tables:
