...
Release `50.5.3-prod-r1-snapshot-detail-alignment` adds three Timescale hypertables without changing the existing current-state, Abuse, Storage I/O or Consumption tables:
