...
Release `50.4.4-prod-r1-manifest-consumption-ui-fix` adds three Timescale hypertables without changing the existing current-state, Abuse, Storage I/O or Consumption tables:
