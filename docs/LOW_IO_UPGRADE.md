...
`50.6.0-prod-r1-node-groups-country-flags` is an **in-place upgrade** from the existing PostgreSQL-native VirtInfra Monitor release. It is not a clean-install-only branch.
