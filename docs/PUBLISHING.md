...
```text
checkout: /.data/agent
archive:  /root/virtinfra-monitor-50.5.8-prod-r5-professional-ui-storage-hotfix-github-production.zip
```

```bash
set -euo pipefail

ZIP=/root/virtinfra-monitor-50.5.8-prod-r5-professional-ui-storage-hotfix-github-production.zip
REPO=/.data/agent
