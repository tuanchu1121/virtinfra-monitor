...
```text
checkout: /.data/agent
archive:  /root/virtinfra-monitor-50.5.4-prod-r1-snapshot-detail-correctness-github-production.zip
```

```bash
set -euo pipefail

ZIP=/root/virtinfra-monitor-50.5.4-prod-r1-snapshot-detail-correctness-github-production.zip
REPO=/.data/agent
