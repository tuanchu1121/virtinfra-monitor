...
```text
checkout: /.data/agent
archive:  /root/virtinfra-monitor-50.5.8-prod-r1-low-io-compatible-github-production.zip
```

```bash
set -euo pipefail

ZIP=/root/virtinfra-monitor-50.5.8-prod-r1-low-io-compatible-github-production.zip
REPO=/.data/agent
