...
```text
checkout: /.data/agent
archive:  /root/virtinfra-monitor-50.6.0-prod-r1-node-groups-country-flags-github-production.zip
```

```bash
set -euo pipefail

ZIP=/root/virtinfra-monitor-50.6.0-prod-r1-node-groups-country-flags-github-production.zip
REPO=/.data/agent
