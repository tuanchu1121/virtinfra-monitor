...
```text
checkout: /.data/agent
archive:  /root/virtinfra-monitor-50.5.7-prod-r1-safe-queue-canonical-vm-github-production.zip
```

```bash
set -euo pipefail

ZIP=/root/virtinfra-monitor-50.5.7-prod-r1-safe-queue-canonical-vm-github-production.zip
REPO=/.data/agent
