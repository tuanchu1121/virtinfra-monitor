...
```text
checkout: /.data/agent
archive:  /root/virtinfra-monitor-50.5.8-prod-r3-consumption-vm-node-github-production.zip
```

```bash
set -euo pipefail

ZIP=/root/virtinfra-monitor-50.5.8-prod-r3-consumption-vm-node-github-production.zip
REPO=/.data/agent
