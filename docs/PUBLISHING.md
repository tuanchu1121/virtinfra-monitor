...
```text
checkout: /.data/agent
archive:  /root/virtinfra-monitor-50.5.7-prod-r3-mac-push-hotfix-github-production.zip
```

```bash
set -euo pipefail

ZIP=/root/virtinfra-monitor-50.5.7-prod-r3-mac-push-hotfix-github-production.zip
REPO=/.data/agent
