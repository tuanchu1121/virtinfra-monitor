...
```text
checkout: /.data/agent
archive:  /root/virtinfra-monitor-50.4.4-prod-r1-manifest-consumption-ui-fix-github-production.zip
```

```bash
set -euo pipefail

ZIP=/root/virtinfra-monitor-50.4.4-prod-r1-manifest-consumption-ui-fix-github-production.zip
REPO=/.data/agent
