...
```text
checkout: /.data/agent
archive:  /root/virtinfra-monitor-50.5.7-prod-r2-mac-identity-search-github-production.zip
```

```bash
set -euo pipefail

ZIP=/root/virtinfra-monitor-50.5.7-prod-r2-mac-identity-search-github-production.zip
REPO=/.data/agent
