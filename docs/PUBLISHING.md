...
```text
checkout: /.data/agent
archive:  /root/virtinfra-monitor-50.5.9-prod-r2-ui-layout-polish-only-github-production.zip
```

```bash
set -euo pipefail

ZIP=/root/virtinfra-monitor-50.5.9-prod-r2-ui-layout-polish-only-github-production.zip
REPO=/.data/agent
