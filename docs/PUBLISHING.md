...
```text
checkout: /.data/agent
archive:  /root/virtinfra-monitor-50.5.1-prod-r1-full-batch-ingest-github-production.zip
```

```bash
set -euo pipefail

ZIP=/root/virtinfra-monitor-50.5.1-prod-r1-full-batch-ingest-github-production.zip
REPO=/.data/agent
