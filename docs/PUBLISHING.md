...
```text
checkout: /.data/agent
archive:  /root/virtinfra-monitor-50.5.9-prod-r3-ui-alignment-overflow-hotfix-github-production.zip
```

```bash
set -euo pipefail

ZIP=/root/virtinfra-monitor-50.5.9-prod-r3-ui-alignment-overflow-hotfix-github-production.zip
REPO=/.data/agent
