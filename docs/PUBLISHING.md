...
```text
checkout: /.data/agent
archive:  /root/virtinfra-monitor-50.5.9-prod-r9-safe-runtime-history-prune-github-production.zip
```

```bash
set -euo pipefail

ZIP=/root/virtinfra-monitor-50.5.9-prod-r9-safe-runtime-history-prune-github-production.zip
REPO=/.data/agent
