...
```text
checkout: /.data/agent
archive:  /root/virtinfra-monitor-50.6.0-prod-r2-node-groups-update-detection-fix-github-production.zip
```

```bash
set -euo pipefail

ZIP=/root/virtinfra-monitor-50.6.0-prod-r2-node-groups-update-detection-fix-github-production.zip
REPO=/.data/agent
