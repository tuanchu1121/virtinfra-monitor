...
[[ "$(cat VERSION)" == "50.5.1-prod-r1-full-batch-ingest" ]] || fail "VERSION mismatch"
...
log "Run v50.5.1 full batch ingest contract"
"$PYTHON" tests/test_v5051_full_batch_ingest.py
