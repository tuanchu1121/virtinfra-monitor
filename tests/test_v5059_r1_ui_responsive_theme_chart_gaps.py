...
def test_release_marker():
    assert (ROOT / "VERSION").read_text(encoding="utf-8").strip() == "50.5.9-prod-r2-ui-layout-polish-only"
    assert 'V5059R2_RELEASE = "50.5.9-prod-r2-ui-layout-polish-only"' in APP
