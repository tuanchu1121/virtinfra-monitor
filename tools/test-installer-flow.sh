...
for required in \
  ...
  011_node_groups.sql 012_node_groups_r6_safety.sql 013_maintenance_queue_boolean.sql 014_node_vm_consumption_rollups.sql 015_consumption_ingest_preaggregation.sql maintenance_queue.py \
  maintenance_dispatch.py runtime_loader.py runtime_layers node_groups.py \
  consumption_rollup.py benchmark-r22-top-vm.py validate-consumption-query-plans.py bw-monitor-inventory-cleanup.timer; do
